...
git submodule add https://github.com/mattn/webapi-vim.git home/vim/bundle/webapi
...
git submodule add https://github.com/pangloss/vim-javascript.git home/vim/bundle/javascript
...
git submodule add https://github.com/kana/vim-textobj-entire.git home/vim/bundle/entire
